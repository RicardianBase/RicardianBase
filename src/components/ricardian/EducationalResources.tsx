...
const resources = [
  ...
  { image: edu2, title: "Escrow Fundamentals", pill: "Legal Ops" },
  { image: edu3, title: "Dispute Resolution Frameworks", pill: "Finance" },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-medium text-gray-900 leading-snug max-w-xl">
            Our{" "}
            <span className="text-blue-500 font-instrument italic">Enterprise Webinars</span>{" "}
            are an invaluable resource for procurement teams and legal operations looking to deepen their understanding of Ricardian contracting.
          </h2>
          <div className="mt-6 md:mt-0 flex items-center gap-3 flex-shrink-0">
            ...
            <span className="bg-blue-100 text-blue-600 text-xs font-medium px-4 py-1.5 rounded-full cursor-pointer hover:bg-blue-200 transition-colors">
              See All
            </span>
          </div>
        </div>
          ...
          {resources.map((r, i) => (
            ...
            >
              <div className="h-[160px] flex items-center justify-center bg-gray-50 rounded-xl">
                <img src={r.image} alt={r.title} className="h-[120px] w-auto object-contain" loading="lazy" width={512} height={512} />
              </div>
